...
public class DubboTestServiceImpl implements DubboTestService {
    ...
    public String testDubbo() {
        LogUtil.log(this.getClass()).info("client is coming ****************************************************");
        LogUtil.log(this.getClass()).info("dubbo interface is running");
...
//        System.out.println(JSON.toJSONString(consumeMsg));
        LogUtil.log(DubboTestServiceImpl.class).info("client is coming ****************************************************");
        LogUtil.log(DubboTestServiceImpl.class).info("dubbo interface is running");
    }
}
